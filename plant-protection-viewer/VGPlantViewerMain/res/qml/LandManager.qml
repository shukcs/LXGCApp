...
Page {
    ...
    function onDetail(obj) {
        ...
        if (page) {
            ...
            vgMainPage.headerName = qsTr("Boundary information")//qsTr("地边信息")
        ...
        LandInfoEdit {
            onClickedOK: {
                ...
                if (land) {
                    ...
                    page.landBoundary = landManager.editBoundary(land)
        ...
        VGMap{
            ...
            MapQuickItem {
                ...
                sourceItem: Rectangle {
                    ...
                    Text{
                        ...
                        text:                       selectObj?(selectObj.landArea.toFixed(2)+qsTr("Acre")):""
            ...
            Rectangle {
                ...
                Text{
                    ...
                    text:                       qsTr("Select land")//qsTr("选择地块")
                    anchors.centerIn:           parent
                }
                Text{
                    font:                       vgMainPage.font()
                    text:                       qsTr("Finish")//qsTr("完成")
