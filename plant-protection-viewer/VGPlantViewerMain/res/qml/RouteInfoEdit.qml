        ...
        Column{
            ...
            Rectangle {
                ...
                VGComboBox{
                    ...
                    anchors     {verticalCenter: parent.verticalCenter; right: parent.right; rightMargin: 20}
                    width:                      parent.width*2/3
                    model:                      [qsTr("Control agent"), qsTr("Herbicide"), qsTr("Insecticide"),qsTr("Foliar")]//"控旺剂", "除草剂", "杀虫剂","叶面肥"
                }
                Rectangle{
                    height: 1
                    width:  parent.width
            ...
            Rectangle {
                ...
                Label{
                    ...
                    anchors.left:               parent.left
                    anchors.leftMargin:         20
                    text:                       qsTr("Prize(Y/A):")//qsTr("单价(元/亩):")
                    font:                       vgMainPage.font()
                    color:                      "gray"
                }
                VGTextField{
