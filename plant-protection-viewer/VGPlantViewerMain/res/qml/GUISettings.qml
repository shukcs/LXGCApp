    ...
    Column {
        ...
        Rectangle {
            ...
            VGValueItem{
                ...
                strKey:  qsTr("QX position setting")//qsTr("千寻定位设置")
        ...
        Rectangle {
            ...
            VGValueItem{
                id: vVoicSt
                anchors {fill:parent; rightMargin:10;leftMargin: 15}
                strKey:  qsTr("Voice setting")//qsTr("语音播报设置")
                keyFont: vgMainPage.biggerFont()
                bTip:    true
                onClickedBtn: {
                    if (!voicePage) {
        ...
        Rectangle {
            ...
            Label{
                ...
                text:                qsTr("Start setting")//qsTr("启动作业设置")
            ...
            RowLayout {
                ...
                VGRadioButton {
                    id:   rdOneKeyArmed
                    text: qsTr("Start by one key")//qsTr("一键启动")
                    checked: true
                ...
                VGRadioButton {
                    id:   rdArmed
                    text: qsTr("Start after upload mission")//qsTr("发送航线后再点击启动")
                    ftText: vgMainPage.font()
                    exclusiveGroup: groupArm
                    onCheckedChanged: rctOp.changedArmed()
                }
        ...
        Rectangle {
            ...
            Label{
                id:labelType
                anchors {left: parent.left; leftMargin: 25; top:parent.top; topMargin: 10}
                text:                qsTr("Map switch")//qsTr("卫星地图切换")
                horizontalAlignment: Text.AlignHCenter
                font:                vgMainPage.biggerFont()
            }
            RowLayout {
                ...
                VGRadioButton {
                    id:   btnGoogle
                    text: qsTr("Google map")//qsTr("谷歌卫星地图")
                    checked: true
                    ftText: vgMainPage.font()
        ...
        Rectangle {
            ...
            Label{
                id:                     lbPos
                text:                   qsTr("Map center")//qsTr("地图定位")
