...
Map {
    ...
    gesture {flickDeceleration: 3000; enabled: true;
        acceptedGestures: MapGestureArea.PanGesture|MapGestureArea.FlickGesture|MapGestureArea.PinchGesture}
    color:  "black"

   // property alias  bDrawCenter:     false
    ...
    Rectangle {
        ...
        Column {
            ...
            spacing: 3
            VGToolButton  {
                visible: btnModel.hasBtn("deviceOpt")
                colNormal:  "transparent"
                iconName:	"deviceOpt"
                onBtnClicked: { emit:clickBtn("deviceOpt") }
            }
            VGToolButton  {
                colNormal:  "transparent"
                iconName:	"bluetooth"
            ...
            VGToolButton  {
                colNormal:  "transparent"
                visible: btnModel.hasBtn("Uav_select")
                iconName:	"craft"
                onBtnClicked: { emit:clickBtn("Uav_select") }
            }
        }
    }
    Rectangle {
        ...
        Column {
            id: colBtn
            anchors {centerIn: parent; margins: 1}
            width: parent.width-2
            spacing: 3
            VGToolButton  {
