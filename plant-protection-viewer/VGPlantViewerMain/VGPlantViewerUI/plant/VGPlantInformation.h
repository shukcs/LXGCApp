...
public:
    ...
    void TestPump();
	void TestMotor(int idx, int ms, int speedd, int count);
    void Shutdown();
...
protected:
    ...
    double GetLat()const;
    double GetLon()const;
    Q_INVOKABLE VGVehicleMission *beginOperation(VGMissionPlan *fr);
signals:
...
private:
    ...
    void sendCommandInt(int cmd, float f1 = 0, float f2 = 0, float f3 = 0, float f4 = 0, int x = 0, int y = 0, float z=0);
