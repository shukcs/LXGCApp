...
class VGVehicleMission : public MapAbstractItem
{
    ...
    Q_PROPERTY(int count READ GetCountOperationLine CONSTANT)
    ...
    Q_PROPERTY(bool hasSuspend READ HasSuspend NOTIFY hasSuspendChanged)
    Q_PROPERTY(bool msSuspend READ IsMissionSuspend WRITE SetMissionSuspend NOTIFY msSuspendChanged)
...
protected:
    ...
    int GetCountOperationLine()const;
    bool HasSuspend()const;
    bool IsMissionSuspend()const;
    void SetMissionSuspend(bool);
signals:
    ...
    void hasSuspendChanged();
    void msSuspendChanged();
