...
bool VGMapManager::IsCenterVisible() const
{
    return m_bCenterVisible;
}

void VGMapManager::SetCenterVisible(bool b)
{
    if (m_bCenterVisible != b)
    {
        m_bCenterVisible = b;
        emit centerVisibleChanged(b);
    }
}
