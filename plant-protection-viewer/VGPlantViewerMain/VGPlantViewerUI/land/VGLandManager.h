...
public:
    ...
    void SetCurFlyRoute(VGMissionPlan *rt);
    void SetCurWPPlan(VGWayPointPlan *rt);
    QList<VGMissionPlan*> GetRoutesOfBoundary(VGLandBoundary *bdr);
    void  BoundaryChanged(const QList<double> &bdr);
    int   Indexof(VGMissionPlan *rt);
    void  AddChild(MapAbstractItem *item);
    void  InitialNetWork(VGNetManager *nm);
    VGLandBoundary * getVGLandBoundaryById(const QString &id);
    ...
    VGMissionPlan *Clone(VGMissionPlan *item, VGLandBoundary *p);
    ...
    const QList<VGMissionPlan*> &FlyRoutes()const;
    const QList<VGWayPointPlan*> &WayPointPlans()const;
public:
    static void CloseGPS();
    static VGGetGpsLocation *GetGps();
    static void PreparePlanRoute(VGMissionPlan *fr);
    static VGPlanningWorker *PlanningWorker();
protected:
    //只允许Qml调用
    Q_INVOKABLE  VGMissionPlan *preparePlanRoute(VGLandBoundary *bdy);
    Q_INVOKABLE  VGWayPointPlan *preparePlanWayPoint();
    ...
    VGMissionPlan *GetCurFlyRoute()const;
    VGWayPointPlan *GetCurWPPlan()const;
...
signals:
    ...
    void    curFlyRouteChanged(VGMissionPlan *rt);
    void    curWPPlanChanged(VGWayPointPlan *rt);
...
private:
    ...
    VGMissionPlan     *_getPlanFlyRoute(VGLandBoundary *bdy);
    ...
    bool appendRoute(VGMissionPlan *fr);
private:
    int                                 m_tmId;
    ...
    QList<VGMissionPlan*>               m_lstRoute;         //规划列表
    QList<VGWayPointPlan*>              m_wpPlans;          //WayPoint航线列表
