...
QList<CoordinateList> VGPlanningWorker::GenShrinkBoudary(VGMissionPlan *rt, const QGeoCoordinate &c)
{
...
bool VGPlanningWorker::IsSafeRoute(VGMissionPlan *rt, const QGeoCoordinate &p1, const QGeoCoordinate &p2)
{
    if (!_genPlanBoudary(rt))
        return true;
...
void VGPlanningWorker::BoundaryPlan(VGMissionPlan *rt, const QGeoCoordinate &c)
{
    if (rt)
        emit planning(rt, c);
}
...
void VGPlanningWorker::onPlanning(VGMissionPlan *rt, const QGeoCoordinate &home)
{
...
bool VGPlanningWorker::_genPlanBoudary(VGMissionPlan *rt)
{
    if (!rt)
        return false;
...
bool VGPlanningWorker::GenMissionBoundary(VGMissionPlan *fr, VGPlanningWorker *bdStruct, const QGeoCoordinate &home)
{
    if (!bdStruct || !fr)
        return false;
